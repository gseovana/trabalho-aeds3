...
class Graph:
  ...
  def bfs(self, start_node: Any) -> Tuple[List[Any], Dict[Any, Any]]:
    """
    Perform Breadth-First Search (BFS) starting from the specified start node.

    Parameters:
    - start_node: The start node for the BFS traversal.

    Returns:
    A tuple containing a list of visited nodes in BFS order and a dictionary of predecessors.
    """
    visited = []
